                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                <b class="col-12 col-sm-3 col-form-label text-sm-right">{{lang("system_water")}}:<i
                                        class="text-danger">*</i></b>
                                <div class="col-12 col-sm-8 col-lg-6 pt-1">
                                    <input class="form-control" type='text' name="system_name" required=""
                                        readonly="" />
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6 pt-1">
                                    ...
                                    <input class="form-control" type='hidden' name="department_id" required=""
                                        readonly="" />
                                    <input class="form-control" type='hidden' name="system_id" required=""
                                        readonly="" />
