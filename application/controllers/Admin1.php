...
class Admin1 extends MY_Controller
{
    ...
    {
        redirect('/admin1/manage');
    }

    public function manage()
    {
        $this->load->view('include/auth/manage');
    }
    ...
    public function permissions()
    {
        ...
        $this->load->view('include/auth/permissions', $data);
    }

    public function add_permission()
    {
        if ($this->input->post() && $this->input->post('cancel'))
            redirect('/admin1/permissions', 'refresh');
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $this->load->view('include/auth/add_permission', $data);
        } else {
    ...
    public function update_permission()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $this->load->view('include/auth/edit_permission', $data);
        } else {
    ...
    public function delete_permission()
    {
        ...
        if ($this->input->post() && $this->input->post('delete')) {
            ...
            $this->load->view('include/auth/delete_permission', $data);
        }
    }
    ...
    public function groups()
    {
        ...
        $this->load->view('include/auth/groups', $data);
    }

    public function group_permissions()
    {
        if ($this->input->post() && $this->input->post('cancel'))
            redirect('/admin1/groups', 'refresh');
        ...
        $this->load->view('/include/auth/group_permissions', $data);
    }
    ...
    public function users()
    {
        ...
        $this->load->view('/include/auth/users', $data);
    }
    ...
    public function manage_user()
    {
        ...
        $this->load->view('/include/auth/manage_user', $data);
    }
    ...
    public function user_permissions()
    {
        ...
        if ($this->input->post() && $this->input->post('cancel'))
            redirect("/admin1/manage-user/{$user_id}", 'refresh');
        ...
        if ($this->input->post() && $this->input->post('save')) {
            ...
            redirect("/admin1/manage_user/{$user_id}", 'refresh');
        }
        ...
        $this->load->view('/include/auth/user_permissions', $data);
    }
}
